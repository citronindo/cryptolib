...
namespace citronindo.crypto.curve25519
{
    public class Curve
    {
        ...
        {
            return Curve25519.getInstance().isNative();
        }

        public static ECKeyPair generateKeyPair()
        {
            KeyPair keyPair = Curve25519.getInstance().generateKeyPair();

            return new ECKeyPair(new DjbECPublicKey(keyPair.PublicKey),
                                 new DjbECPrivateKey(keyPair.PrivateKey));
        }
