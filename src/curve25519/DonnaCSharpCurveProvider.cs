...
namespace citronindo.crypto.curve25519
{
    ...
    /// </summary>
    public class DonnaCSharpCurveProvider : BaseCurveProvider
    {
        public DonnaCSharpCurveProvider(ISha512 sha512provider, SecureRandomProvider secureRandomProvider)
        ...
        public override byte[] generatePublicKey(byte[] privateKey)
        {
            ...
            CurveDonna.curve25519_donna(publicKey, privateKey, basepoint);
            return publicKey;
        }
        ...
        public override byte[] calculateAgreement(byte[] ourPrivate, byte[] theirPublic)
        {
            ...
            CurveDonna.curve25519_donna(sharedKeyAgreement, ourPrivate, theirPublic);
