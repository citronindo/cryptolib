...
using static citronindo.crypto.proto.SessionStructure;
using static citronindo.crypto.proto.SessionStructure.Types;

namespace citronindo.crypto.signal
{
    public class SessionState
	{
		...
		{
			return new RootKey(HKDF.Create(),
		...
		public ChainKey? getReceiverChainKey(ECPublicKey senderEphemeral)
		{
			...
			{
				return new ChainKey(HKDF.Create(),
