...
namespace citronindo.cryptolib.signal.ecc.impl
{
    class Curve25519ManagedProvider : ICurve25519Provider
    {
        private citronindo.cryptolib.curve25519.Curve25519 curve;
        /// <summary>
        /// ctor
        /// </summary>
        ...
        {
            curve = citronindo.cryptolib.curve25519.Curve25519.getInstance(type);
        }
