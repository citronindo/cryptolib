...
namespace citronindo.cryptolib.signal.protocol
{
    ...
    public static partial class WhisperTextProtocolReflection
    {
        ...
        static WhisperTextProtocolReflection()
        {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.protocol.SignalMessage), global::citronindo.cryptolib.signal.protocol.SignalMessage.Parser, new[]{ "RatchetKey", "Counter", "PreviousCounter", "Ciphertext" }, new[]{ "RatchedKeyOneof", "CounterOneof", "PreviousCounterOneof", "CiphertextOneof" }, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.protocol.KeyExchangeMessage), global::citronindo.cryptolib.signal.protocol.KeyExchangeMessage.Parser, new[]{ "Id", "BaseKey", "RatchetKey", "IdentityKey", "BaseKeySignature" }, new[]{ "IdOneof", "BaseKeyOneof", "RatchetKeyOneof", "IdentityKeyOneof", "BaseKeySignatureOneof" }, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.protocol.SenderKeyMessage), global::citronindo.cryptolib.signal.protocol.SenderKeyMessage.Parser, new[]{ "Id", "Iteration", "Ciphertext" }, new[]{ "IdOneof", "IterationOneof", "CiphertextOneof" }, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.protocol.SenderKeyDistributionMessage), global::citronindo.cryptolib.signal.protocol.SenderKeyDistributionMessage.Parser, new[]{ "Id", "Iteration", "ChainKey", "SigningKey" }, new[]{ "IdOneof", "IterationOneof", "ChainKeyOneof", "SigningKeyOneof" }, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.protocol.DeviceConsistencyCodeMessage), global::citronindo.cryptolib.signal.protocol.DeviceConsistencyCodeMessage.Parser, new[]{ "Generation", "Signature" }, new[]{ "GenerationOneof", "SignatureOneof" }, null, null)
                }));
        }
        #endregion
