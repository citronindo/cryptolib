...
using static citronindo.cryptolib.signal.state.SessionStructure;
using static citronindo.cryptolib.signal.state.SessionStructure.Types;

namespace citronindo.cryptolib.signal.state
{
