...
namespace citronindo.cryptolib.signal.state
{
    ...
    public static partial class LocalStorageProtocolReflection
    {
        ...
        static LocalStorageProtocolReflection()
        {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.state.SessionStructure.Types.PendingPreKey), global::citronindo.cryptolib.signal.state.SessionStructure.Types.PendingPreKey.Parser, new[]{ "PreKeyId", "SignedPreKeyId", "BaseKey" }, new[]{ "PreKeyIdOneof", "SignedPreKeyIdOneof", "BaseKeyOneof" }, null, null)}),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.state.RecordStructure), global::citronindo.cryptolib.signal.state.RecordStructure.Parser, new[]{ "CurrentSession", "PreviousSessions" }, new[]{ "SequenceOneof" }, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.state.PreKeyRecordStructure), global::citronindo.cryptolib.signal.state.PreKeyRecordStructure.Parser, new[]{ "Id", "PublicKey", "PrivateKey" }, new[]{ "IdOneof", "PublicKeyOneof", "PrivateKeyOneof" }, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.state.SignedPreKeyRecordStructure), global::citronindo.cryptolib.signal.state.SignedPreKeyRecordStructure.Parser, new[]{ "Id", "PublicKey", "PrivateKey", "Signature", "Timestamp" }, new[]{ "IdOneof", "PublicKeyOneof", "PrivateKeyOneof", "SignatureOneof", "TimestampOneof" }, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.state.IdentityKeyPairStructure), global::citronindo.cryptolib.signal.state.IdentityKeyPairStructure.Parser, new[]{ "PublicKey", "PrivateKey" }, new[]{ "PublicKeyOneof", "PrivateKeyOneof" }, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.state.SenderKeyStateStructure), global::citronindo.cryptolib.signal.state.SenderKeyStateStructure.Parser, new[]{ "SenderKeyId", "SenderChainKey", "SenderSigningKey", "SenderMessageKeys" }, new[]{ "SenderKeyIdOneof", "SenderChainKeyOneof", "SenderSigningKeyOneof" }, null, new pbr::GeneratedClrTypeInfo[] { new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.state.SenderKeyStateStructure.Types.SenderChainKey), global::citronindo.cryptolib.signal.state.SenderKeyStateStructure.Types.SenderChainKey.Parser, new[]{ "Iteration", "Seed" }, new[]{ "IterationOneof", "SeedOneof" }, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.state.SenderKeyStateStructure.Types.SenderMessageKey), global::citronindo.cryptolib.signal.state.SenderKeyStateStructure.Types.SenderMessageKey.Parser, new[]{ "Iteration", "Seed" }, new[]{ "IterationOneof", "SeedOneof" }, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.state.SenderKeyStateStructure.Types.SenderSigningKey), global::citronindo.cryptolib.signal.state.SenderKeyStateStructure.Types.SenderSigningKey.Parser, new[]{ "Public", "Private" }, new[]{ "PublicOneof", "PrivateOneof" }, null, null)}),
            new pbr::GeneratedClrTypeInfo(typeof(global::citronindo.cryptolib.signal.state.SenderKeyRecordStructure), global::citronindo.cryptolib.signal.state.SenderKeyRecordStructure.Parser, new[]{ "SenderKeyStates" }, null, null, null)
                }));
        }
        #endregion
