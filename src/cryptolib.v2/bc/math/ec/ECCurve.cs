...
using citronindo.cryptolib.bc.Math.EC.Abc;
using citronindo.cryptolib.bc.Math.EC.Endo;
using citronindo.cryptolib.bc.Math.EC.Multiplier;
using citronindo.cryptolib.bc.Math.Field;
...
namespace citronindo.cryptolib.bc.Math.EC
{
        ...
        : AbstractFpCurve
    {
            ...
            : base(q)
        {
            ...
            {
                int maxBitLength = AsInteger("citronindo.cryptolib.bc.EC.Fp_MaxSize", 1042); // 2 * 521
                int certainty = AsInteger("citronindo.cryptolib.bc.EC.Fp_Certainty", 100);
