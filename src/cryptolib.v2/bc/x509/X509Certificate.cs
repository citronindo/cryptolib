...
using citronindo.cryptolib.bc.Asn1.Utilities;
...
using citronindo.cryptolib.bc.X509.Extension;
...
namespace citronindo.cryptolib.bc.X509
{
    ...
    //		, PKCS12BagAttributeCarrier
    {
        ...
        /// <summary>
        /// Return a <see cref="citronindo.cryptolib.bc.Math.BigInteger">BigInteger</see> containing the serial number.
        /// </summary>
