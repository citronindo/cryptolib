...
namespace citronindo.cryptolib.bc.Crmf
{
    ...
    {
        public static readonly int popRaVerified = citronindo.cryptolib.bc.Asn1.Crmf.ProofOfPossession.TYPE_RA_VERIFIED;
        public static readonly int popSigningKey = citronindo.cryptolib.bc.Asn1.Crmf.ProofOfPossession.TYPE_SIGNING_KEY;
        public static readonly int popKeyEncipherment = citronindo.cryptolib.bc.Asn1.Crmf.ProofOfPossession.TYPE_KEY_ENCIPHERMENT;
        public static readonly int popKeyAgreement = citronindo.cryptolib.bc.Asn1.Crmf.ProofOfPossession.TYPE_KEY_AGREEMENT;
