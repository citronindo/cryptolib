...
namespace citronindo.cryptolib.bc.Crypto.Fpe
{
    /*
    ...
    {
        internal static readonly string FPE_DISABLED = "citronindo.cryptolib.bc.Fpe.Disable";
        internal static readonly string FF1_DISABLED = "citronindo.cryptolib.bc.Fpe.Disable_Ff1";
