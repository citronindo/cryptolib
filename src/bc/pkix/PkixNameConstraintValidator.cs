...
using citronindo.cryptolib.bc.Asn1.X500;
using citronindo.cryptolib.bc.Asn1.X500.Style;
...
namespace citronindo.cryptolib.bc.Pkix
{
    public class PkixNameConstraintValidator
    {
        ...
        {
            if (citronindo.cryptolib.bc.Utilities.Arrays.AreEqual(ip1, ip2))
            {
                return 0;
            }
            if (citronindo.cryptolib.bc.Utilities.Arrays.AreEqual(Max(ip1, ip2), ip1))
            {
                return 1;
            }
            return -1;
