...
namespace citronindo.cryptolib.bc.Crypto.Encodings
{
    /**
    ...
    */
        ...
        : IAsymmetricBlockCipher
    {
         ...
         * work with one of these set the system property citronindo.cryptolib.bc.Pkcs1.Strict to false.
         */
        public const string StrictLengthEnabledProperty = "citronindo.cryptolib.bc.Pkcs1.Strict";
