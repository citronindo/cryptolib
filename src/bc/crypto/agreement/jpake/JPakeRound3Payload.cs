...
namespace citronindo.cryptolib.bc.Crypto.Agreement.JPake
{
    /// <summary>
    ...
    public class JPakeRound3Payload
    {
        ...
        /// 
        /// See JPAKEUtil#calculateMacTag(string, string, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, citronindo.cryptolib.bc.crypto.Digest)
        /// </summary>
