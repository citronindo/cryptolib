...
namespace citronindo.cryptolib.bc.Crypto.Engines
{
	...
	*/
		...
		: IAsymmetricBlockCipher
	{
		...
		*
		* @see citronindo.cryptolib.bc.crypto.AsymmetricBlockCipher#init(bool,
		*      citronindo.cryptolib.bc.crypto.CipherParameters)
		*/
...
//						accJ = priv.PhiN.Multiply(bigJ);
		...
		*
		* @see citronindo.cryptolib.bc.crypto.AsymmetricBlockCipher#GetInputBlockSize()
		*/
...
//				return key.Modulus.ToByteArray().Length;
		...
		*
		* @see citronindo.cryptolib.bc.crypto.AsymmetricBlockCipher#GetOutputBlockSize()
		*/
...
//				return key.Modulus.ToByteArray().Length;
		...
		*
		* @see citronindo.cryptolib.bc.crypto.AsymmetricBlockCipher#ProcessBlock(byte[],
		*      int, int)
		*/
