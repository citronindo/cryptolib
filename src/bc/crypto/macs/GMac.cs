...
namespace citronindo.cryptolib.bc.Crypto.Macs
{
        ...
        : IMac
    {
        ...
        /// <summary>
        /// Initialises the GMAC - requires a <see cref="citronindo.cryptolib.bc.Crypto.Parameters.ParametersWithIV"/> 
        /// providing a <see cref="citronindo.cryptolib.bc.Crypto.Parameters.KeyParameter"/> and a nonce.
        /// </summary>
