...
namespace citronindo.cryptolib.bc.Asn1.X509.SigI
{
	/**
	...
	* </pre>
	*
	* @see citronindo.cryptolib.bc.asn1.x509.sigi.NameOrPseudonym
	* @see citronindo.cryptolib.bc.asn1.x509.sigi.SigIObjectIdentifiers
	*/
