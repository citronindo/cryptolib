...
namespace citronindo.crypto.digest
{
    public class xeddsa
    {
            ...
            byte[] random)
        {
            ...
            // https://github.com/WhisperSystems/Curve-java/commit/2f388f601afdac6a78a19ced2f0629da1ff9800f#diff-6e488e4e28814b3fa524b6781fcaf912R19
            ...
            Array.Copy(Curve_privkey, 0, a, 0, 32);
        ...
        public static int xed25519_verify(ISha512 sha512provider, byte[] signature, byte[] Curve_pubkey, byte[] msg, int msg_len)
        {
            int[] u = new int[10];
            int[] y = new int[10];
            ...
            /* Convert the Curve public key into an Ed25519 public key.
             * 
             * y = (u - 1) / (u + 1)
             * 
             * NOTE: u=-1 is converted to y=0 since fe_invert is mod-exp
             */
            if (!Fe_isreduced.fe_isreduced(Curve_pubkey))
                return -1;
